   ...
   case "${1}" in
      ...
      help|--help|-h)
         ...
         then
            ...
            echo "\t-td, --threaddump=COUNT,INTERVAL   send a 3 signal via kernel, COUNT times between INTERVAL"
            echo "\t-hd, --heapdump=COUNT,INTERVAL     send a 21 signal via kernel, COUNT times between INTERVAL"
